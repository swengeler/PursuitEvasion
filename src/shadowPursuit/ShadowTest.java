...
public class ShadowTest {
    ...
    public ShadowTest() {
        ...
        environment = new Polygon(36.0,273.0,272.0,189.0,333.0,137.0,480.0,97.0,609.0,97.0,720.0,140.0,727.0,192.0,709.0,209.0,600.0,188.0,534.0,156.0,435.0,178.0,356.0,240.0,343.0,336.0,440.0,421.0,560.0,408.0,681.0,339.0,775.0,291.0,799.0,183.0,818.0,141.0,891.0,225.0,871.0,393.0,767.0,548.0,621.0,636.0,503.0,550.0,585.0,427.0,640.0,393.0,444.0,458.0,306.0,536.0,267.0,647.0,300.0,726.0,489.0,747.0,557.0,640.0,565.0,711.0,552.0,759.0,437.0,771.0,364.0,765.0,274.0,757.0,124.0,691.0,67.0,559.0,95.0,431.0,228.0,360.0,286.0,377.0);

        Point2D agent1Pos = new Point2D(286, 397);
        Point2D agent2Pos = new Point2D(548, 640);
