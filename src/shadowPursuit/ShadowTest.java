...
public class ShadowTest {
    ...
    public ShadowTest() {
        ...
        environment = new Polygon(507.0,119.0,326.0,291.0,489.0,211.0,489.0,262.0,343.0,379.0,282.0,154.0,190.0,326.0,309.0,420.0,544.0,484.0,919.0,243.0,701.0,357.0,691.0,315.0,598.0,403.0,557.0,271.0,549.0,213.0,639.0,250.0);
        Point2D agentPos = new Point2D(524, 233);
